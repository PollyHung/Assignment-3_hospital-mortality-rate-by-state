###rankall takes 2 arguments outcome name (outcome) and hospital rank (num). 
###returns 2 colun data frame containing the hospital in each state that has 
...
rankall <- function(outcome, num="best") {
  ...
  #use for loop to iterate over each state, split the table by state, 
  #and extract the rank 1 hospital (i.e., row 1)
